...
const MODULES = [
  ...
  { icon: PlayCircle,    title: 'Rubric Learning Videos', desc: 'Every CBC rubric links to matching learning videos, so a learner\'s report card doubles as a personalised revision playlist. Teachers and parents can watch straight from the mark list or report card.', color: 'bg-rose-600' },
