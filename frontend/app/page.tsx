...
const MODULES = [
  ...
  { icon: PlayCircle,    title: 'Rubric Learning Videos', desc: 'Selected CBC sub-strands in the assessment rubrics link to matching learning videos — accessed from the rubrics themselves, not the mark list or report card — giving teachers and parents (on behalf of learners) targeted revision material.', color: 'bg-rose-600' },
