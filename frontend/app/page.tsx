...
const MODULES = [
  ...
  { icon: PlayCircle,    title: 'Teaching & Learning Videos', desc: 'Selected learning area sub-strands in the assessment digital books have matching learning videos, giving teachers and learners access to digital learning materials at any time.', color: 'bg-rose-600' },
