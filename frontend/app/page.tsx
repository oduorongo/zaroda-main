...
const MODULES = [
  ...
  { icon: PlayCircle,    title: 'Rubric Learning Videos', desc: 'Selected CBC sub-strands in the assessment book link to matching learning videos, giving teachers and parents (on behalf of learners) targeted revision material right where marks are entered.', color: 'bg-rose-600' },
