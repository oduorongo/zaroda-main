...
// The ZARODA Sports Base is a SEPARATE platform (the commercial championship layer). Set its
    ...
    <div className="space-y-5">
      ...
      {BASE_URL ? (
        <div className="card overflow-hidden" style={{ height: '70vh' }}>
          ...
          <iframe src={BASE_URL} className="w-full border-0" style={{ height: 'calc(100% - 36px)' }} title="ZARODA Sports Base"/>
        </div>
      ) : (
        <div className="card p-8 text-center max-w-xl mx-auto">
          ...
          <h3 className="font-bold text-theme-heading mb-2">Sports Base not connected yet</h3>
          <p className="text-sm text-theme-muted mb-4">
            The ZARODA Sports Base is the central championship platform where school teams are entered into
          ...
          <p className="text-sm text-theme-muted">
            ...
            the Base platform's web address in the frontend service settings, then redeploy. Once linked, your
