  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-6">
        ...
        <p className="text-white/40 text-xs mt-1">Generate CBE KICD aligned schemes, lesson plans &amp; lesson notes on your own. Your first Scheme of Work is free — after that, top up your wallet via M-Pesa and pay KES 30 per scheme and KES 2 per lesson plan or lesson notes.</p>
      </div>
