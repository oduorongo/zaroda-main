              ...
              <div key={t.id} className="card p-4">
                ...
                <div className="flex items-center justify-between flex-wrap gap-2 mt-3">
                  <div>
                    ...
                    <div className={`text-xs mt-1 font-semibold ${t.documentsGenerated > 0 ? 'text-green-700' : 'text-red-600'}`}>
                      {t.documentsGenerated > 0
                        ? `✓ Verified: ${t.documentsGenerated} document${t.documentsGenerated === 1 ? '' : 's'} generated by this account`
                        : '⚠ This account has generated 0 documents — check the wording before featuring'}
                    </div>
                    {t.rating && (
