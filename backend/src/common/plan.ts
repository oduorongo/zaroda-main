...
// covers fee recording only; Pro additionally unlocks detailed reports/analytics,
// payroll, HR, and student transport. Call this at the top of any endpoint that
// belongs to a Pro-only feature, passing a short human name for the error message.
