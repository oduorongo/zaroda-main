...
async function bootstrap() {
  ...
  httpAdapter.get('/health', (_req: any, res: any) => {
    res.json({ status: 'ok', service: 'zaroda-sms-api', build: 'zaroda-sports-rename-2026-06-26', features: ['mark-list-readonly', 'creative-arts-normalize', 'stream-grade-trust', 'dashboard-top-classes', 'assessment-progress', 'parent-analytics', 'enrollment-trend'], timestamp: new Date().toISOString() });
  });
